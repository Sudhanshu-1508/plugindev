<div class="wrap">
    ...
    <form method="post" action="<?php echo admin_url('edit.php?post_type=news&page=news-settings' ) ?>">
        ...
        <table class="form-table">
            <tbody>
                <tr>
                    <th><label for="news_related_title"><?php echo esc_html (__( isset( $_POST['news_related_title']) ? $_POST['news_related_title'] : get_option('news_related_title', 'Related News' ) ) ) ?></label></th>
                ...
                <tr>
                    <th><label for="show_related"><?php echo esc_html (__('Show Related News?', 'myplugin-sk')) ?></label></th>
